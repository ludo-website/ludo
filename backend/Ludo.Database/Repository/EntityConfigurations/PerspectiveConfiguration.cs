...
public class PerspectiveConfiguration : IEntityTypeConfiguration<Perspective>
{
    public void Configure(EntityTypeBuilder<Perspective> builder)
    {
        ...
        builder.HasMany(e => e.Games).WithMany(e => e.Perspectives).UsingEntity<GamePerspective>();
    }
}

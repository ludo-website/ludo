...
public class AestheticConfiguration : IEntityTypeConfiguration<Aesthetic>
{
    public void Configure(EntityTypeBuilder<Aesthetic> builder)
    {
        ...
        builder.HasMany(e => e.Games).WithMany(e => e.Aesthetics).UsingEntity<GameAesthetic>();
    }
}

...
{
    public Task<ServiceResponse> Add(GameAestheticCreateRecord gameAesthetic, AccountRecord? requestingAccount = null, CancellationToken cancellationToken = default);

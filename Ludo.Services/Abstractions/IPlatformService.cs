...
{
    public Task<ServiceResponse> Add(PlatformCreateRecord platform, AccountRecord? requestingAccount = null, CancellationToken cancellationToken = default);
    ...
    public Task<ServiceResponse> Update(PlatformUpdateRecord platform, AccountRecord? requestingAccount = null, CancellationToken cancellationToken = default);

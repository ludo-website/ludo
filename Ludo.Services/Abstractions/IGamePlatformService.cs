...
{
    public Task<ServiceResponse> Add(GamePlatformCreateRecord gamePlatform, AccountRecord? requestingAccount = null, CancellationToken cancellationToken = default);
